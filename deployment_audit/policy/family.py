...
class PolicySpec:
    ...
    def _selected_score(self, route_score: float, bin_margin: float, bin_score: float) -> float:
    ...
    def accepts(self, pad_words: int, difficulty_tier: str, route_score: float, bin_margin: float, bin_score: float) -> bool:
        score_value = self._selected_score(route_score=route_score, bin_margin=bin_margin, bin_score=bin_score)
